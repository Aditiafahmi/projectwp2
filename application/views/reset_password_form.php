              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-5 pb-2 mt-4">
                    <h5 class="card-title text-center pb-0 fs-2 fw-semibold">Reset Password</h5>
                    <p class="text-center small text-secondary">Masukkan password baru Anda minimal 6 digit angka/huruf</p>
                  </div>
                  <form method="post" action="<?= base_url('reset_password/process_reset_password'); ?>"
                    class="row g-3">
                    <div class="col-12">
                      <input type="password" name="password" class="form-control" id="resetPassword"
                        placeholder="Password Baru" required="required" autocomplete="off">
                    </div>
                    <div class="col-12">
                      <input type="password" name="confirm_password" class="form-control" id="confirmPassword"
                        placeholder="Konfirmasi Password Baru" required="required" autocomplete="off">
                    </div>
                    <input type="hidden" name="token" value="<?php echo $token; ?>">
                    <div class="col-12">
                      <button class="btn btn-login w-100 py-2" type="submit">Reset Password</button>
                    </div>
                  </form>
                </div>
              </div>
