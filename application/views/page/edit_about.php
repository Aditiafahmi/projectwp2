<!-- application/views/about/edit_about.php -->
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="col-12">
                    <div class="card about-card">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="<?php echo site_url('page/about/update/' . $about->id); ?>"
                                method="post">
                                <label clas="form-label" for="about_heading">About Heading</label>
                                <input type="text" name="about_heading" value="<?php echo $about->about_heading; ?>"
                                    required>
                                <br>
                                <label clas="form-label" for="about_text">About Text</label>
                                <textarea name="about_text" class="custom-textarea"
                                    required><?php echo $about->about_text; ?></textarea>
