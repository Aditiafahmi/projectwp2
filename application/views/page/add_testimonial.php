<!-- application/views/page/add_testimonial.php -->
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('page/dashboard'); ?>">Home</a></li>
                    <li class="breadcrumb-item"><a href="<?php echo site_url('page/testimonial'); ?>">Testimonial</a>
                    </li>
                ...
                <div class="col-12">
                    <div class="card testimonial-card">
                        <div class="card-body">
                            ...
                            <?php echo form_open_multipart('page/testimonial/do_add'); ?>
                            <div class="col-md-4">
