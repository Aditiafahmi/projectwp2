<!-- application/views/edit_testimonial_view.php -->
...
<head>
    ...
    <title>edit_testi - Marryme</title>
                ...
                <div class="col-12">
                    <div class="card testimonial-card">
                        <div class="card-body">
                            ...
                            <?php echo form_open_multipart('page/testimonial/edit/' . $testimonial['id']); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="testi_client" required="required"
                                    autocomplete="off" value="<?php echo $testimonial['testi_client']; ?>">
                            </div>

                            <div class="col-12">
                                <label class="form-label">Description</label>
                                <textarea class="form-control" name="testi_text"
                                    rows="5"><?php echo $testimonial['testi_text']; ?></textarea>
                            </div>
