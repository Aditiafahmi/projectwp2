...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo base_url('index.php?page=dashboard'); ?>">Home</a>
                    </li>
                    <li class="breadcrumb-item"><a href="<?php echo base_url('index.php?page=blog'); ?>">Blog</a></li>
                ...
                <div class="col-12">
                    <div class="card blog-card">
                        <div class="card-body">
                            ...
                            <?php echo form_open_multipart('page/blogadmin/add'); ?>
                            <div class="col-md-4">
                                <input name="id" value="<?php echo set_value('id'); ?>" hidden />
                            ...
                            <div class="col-12">
                                ...
                                <textarea id="editor1" class="form-control" name="blog_text" rows="5"
