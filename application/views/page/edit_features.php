<!-- application/views/edit_features_view.php -->
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Edit Features - MarryME</title>
    ...
    <!-- Add your stylesheets, Bootstrap, etc. -->
            ...
            <div class="col-12">
                <div class="card features-card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" method="POST" action="<?= site_url('page/features/edit/'.$features->id); ?>" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <input name="id" value="<?= $features->id; ?>" hidden />
                                <label class="form-label">Features Name</label>
                                <input type="text" class="form-control" name="features_name" value="<?= $features->features_name; ?>">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" name="features_icon" value="<?= $features->features_icon; ?>">
