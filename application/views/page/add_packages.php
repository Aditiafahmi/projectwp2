<!-- application/views/add_packages_view.php -->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card packages-card">
                        <div class="card-body">
                            <h5 class="card-title">Tambahkan Data Paket</h5>

                            <?= form_open_multipart(base_url('page/packages/add/')); ?>
                            <div class="col-md-6">
                                <label class="form-label">Judul</label>
                                <?= form_input(['type' => 'text', 'name' => 'packages_heading', 'class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off']); ?>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Harga</label>
                                <?= form_input(['type' => 'text', 'name' => 'packages_price', 'class' => 'form-control', 'required' => 'required', 'autocomplete' => 'off']); ?>
                            </div>
                            <div class="col-12">
                                <label class="form-label">Daftar Paket</label>
                                <p class="example">Gunakan Fitur <code>Bullet List</code> <i
                                        class="fa-solid fa-list-ul"></i> untuk menaruh daftar paket.</p>
                                <?= form_textarea(['id' => 'editor1', 'name' => 'packages_list', 'class' => 'form-control']); ?>
                            </div>
                            <div class="text-end">
                                <?= form_submit(['type' => 'submit', 'class' => 'btn btn-success', 'value' => 'Submit']); ?>
                            </div>
                            <?= form_close(); ?>
                        </div>
                    </div>
